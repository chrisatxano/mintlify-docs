...
<figure><img src="../..//assets/CleanShot 2022-12-28 at 15.58.50.png" alt=""><figcaption></figcaption></figure>

The Microservice function will be similar to an [[external API request](../../the-function-stack/functions/apis-and-lambdas/external-api-request.mdx) function. Although the settings of the function are similar, it's important to call out that the **microservice is all internal traffic, making the interaction secure**.

<figure><img src="../..//assets/CleanShot 2022-12-28 at 16.00.37.png" alt=""><figcaption></figcaption></figure>
...
For more on Import Curl, Method, Params, Headers, Timeout, and Follow\_location check out the [[External API Request](../../the-function-stack/functions/apis-and-lambdas/external-api-request.mdx) page.
