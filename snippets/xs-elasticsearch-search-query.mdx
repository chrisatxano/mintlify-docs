---
title: 'XS -Elasticsearch: Search Query'
---

# <img src="../assets/docuBadge (11).png" alt="" data-size="line" /> Elasticsearch: Search Query <a href="#xs-elasticsearch-search-query" id="xs-elasticsearch-search-query"></a>
