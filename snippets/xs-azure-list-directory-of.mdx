---
title: xs - azure list directory of
---

# <img src="../assets/docuBadge (11).png" alt="" data-size="line" /> Azure Blob Storage: List Directory of <a href="#xs-azurelist" id="xs-azurelist"></a>
