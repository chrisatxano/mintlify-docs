---
title: 'xs - Azure Blob Storage: Get File Metadata'
---

# <img src="../assets/docuBadge (11).png" alt="" data-size="line" /> Azure Blob Storage: Get File Metadata <a href="#xs-azuremetadata" id="xs-azuremetadata"></a>
