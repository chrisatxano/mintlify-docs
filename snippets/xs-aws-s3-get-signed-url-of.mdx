---
title: XS - AWS S3 Get signed url of
---

# <img src="../assets/docuBadge (11).png" alt="" data-size="line" /> AWS S3: Get Signed URL of <a href="#xs-awss3getsignedurl" id="xs-awss3getsignedurl"></a>
