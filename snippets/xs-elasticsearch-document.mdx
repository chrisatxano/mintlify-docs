---
title: 'XS -Elasticsearch: Document'
---

# <img src="../assets/docuBadge (11).png" alt="" data-size="line" /> Elasticsearch: Document <a href="#xs-elasticsearch-document" id="xs-elasticsearch-document"></a>
