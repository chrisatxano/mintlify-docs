---
title: XS DB -geo_polygon_collection
---

# <img src="../assets/docuBadge (11).png" alt="" data-size="line" /> geo\_polygon\_collection <a href="#xs-geo_polygon_collection" id="xs-geo_polygon_collection"></a>
