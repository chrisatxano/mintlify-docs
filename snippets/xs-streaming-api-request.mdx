---
title: XS -Streaming API Request
---

# <img src="../assets/docuBadge (11).png" alt="" data-size="line" /> Streaming API Request <a href="#xs-streaming-api-request" id="xs-streaming-api-request"></a>
