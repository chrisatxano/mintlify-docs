---
title: 'xs - Azure Blob Storage: get signed url'
---

# <img src="../assets/docuBadge (11).png" alt="" data-size="line" /> Azure Blob Storage: Get Signed URL of <a href="#xs-azuregetsignedurl" id="xs-azuregetsignedurl"></a>
