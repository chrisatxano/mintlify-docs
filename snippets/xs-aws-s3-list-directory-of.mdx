---
title: XS - AWS S3 List Directory of
---

# <img src="../assets/docuBadge (11).png" alt="" data-size="line" /> AWS S3: List Directory of <a href="#xs-awss3listdir" id="xs-awss3listdir"></a>
