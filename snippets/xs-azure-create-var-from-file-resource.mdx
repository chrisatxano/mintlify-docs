---
title: XS - azure create var from file resource
---

# <img src="../assets/docuBadge (11).png" alt="" data-size="line" /> Azure Blob Storage: Create Var From File Resource <a href="#xs-azurecreatefile" id="xs-azurecreatefile"></a>
