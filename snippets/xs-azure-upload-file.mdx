---
title: XS - azure upload file
---

# <img src="../assets/docuBadge (11).png" alt="" data-size="line" /> Azure Blob Storage: Upload file to <a href="#xs-azureupload" id="xs-azureupload"></a>
