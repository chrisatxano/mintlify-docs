---
title: XS - AWS OpenSearch Document CRUD
---

# <img src="../assets/docuBadge (11).png" alt="" data-size="line" /> AWS OpenSearch: Document (CRUD) <a href="#xs-awsopensearchdocumentcrud" id="xs-awsopensearchdocumentcrud"></a>
