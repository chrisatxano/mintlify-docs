...
Creating a Private Snippet has the same UI and experience as creating a regular, shareable [[Snippet](../../xano-features/snippets.mdx).
...
The landing page for a Secure Share and installation will be the same as a regular [[Snippet](../../xano-features/snippets.mdx).