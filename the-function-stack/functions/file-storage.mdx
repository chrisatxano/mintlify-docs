...
[[file-storage-in-xano.md](../../file-storage/file-storage-in-xano.mdx)
{% endcontent-ref %}
...
<figure><img src="../..//assets/CleanShot 2025-03-11 at 09.39.47.png" alt=""><figcaption></figcaption></figure>

To ensure it's working as expected, when you run it in Xano, you should see a **Download** button available in the Run panel.

<div align="left"><figure><img src="../..//assets/CleanShot 2025-03-11 at 09.40.41.png" alt="" width="450"><figcaption></figcaption></figure></div>
{% endstep %}
{% endstepper %}
