...
Fill in your desired options, such as **name**, **description**, **tags**, [[**request history**](../../maintenance-monitoring-and-logging/request-history.mdx), and the preferred [[**data source**](../../the-database/database-basics/data-sources.mdx).
{% endstep %}
...
<figure><img src="../..//assets/CleanShot 2024-12-27 at 15.09.18.png" alt="" /><figcaption></figcaption></figure>
