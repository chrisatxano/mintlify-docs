...
<figure><img src="..//assets/image (47).png" alt="" width="450"><figcaption><p>A visual representation of the Software Development Life Cycle</p></figcaption></figure>
...
<figure><img src="..//assets/image (48).png" alt=""><figcaption><p>A visual representation of the Software Development Life Cycle</p></figcaption></figure>
...
* [[Auto-Documentation](../the-function-stack/building-with-visual-development/apis/swagger-openapi-documentation.mdx)
* [[Real-time Collaboration](broken-reference)

If you're working with a team, you can leverage Xano features like [[real-time collaboration](broken-reference) to seamlessly work within the same workspace, or create [[Branches and Merge](../team-collaboration/branching-and-merging.mdx) them in when you're ready to move to the testing phase.
