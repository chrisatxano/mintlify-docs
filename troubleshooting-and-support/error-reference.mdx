...
<img src="..//assets/CleanShot 2023-11-22 at 14.47.11.png" alt="" data-size="original">
...
When using [[Direct Database Query](../the-function-stack/functions/database-requests/direct-database-query.mdx) and dynamically specifying values, make sure that the number of arguments you define in your query statement match the number of substitutions defined in the Statement Arguments section.
...
* Adding [[conditional logic ](../the-function-stack/functions/data-manipulation/conditional.mdx)to determine the steps to take based on the existence of a value
