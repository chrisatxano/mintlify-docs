...
Xano offers several different data types that you can use, and you can review those [[here](field-types.mdx), but for now, we'll focus on some of the more basic ones to get you started.
